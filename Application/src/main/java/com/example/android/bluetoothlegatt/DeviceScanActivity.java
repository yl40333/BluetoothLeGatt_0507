...
public class DeviceScanActivity extends ListActivity {
    ...
    private Button button_peripheral;
    // ...
    private String peripheralDeviceAddress;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        layout.addView(mButtonCentral);
        layout.addView(mButtonPeripheral);
        getListView().addHeaderView(layout);

        mButtonCentral.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mButtonPeripheral.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // create dialog to input peripheral device information
                AlertDialog.Builder builder = new AlertDialog.Builder(DeviceScanActivity.this);
                View view = getLayoutInflater().inflate(R.layout.peripheral_iput, null);
                builder.setView(view);
                final EditText add_device = (EditText) view.findViewById(R.id.edittext_device_address);
                final EditText name_device = (EditText) view.findViewById(R.id.edittext_device_name);
                Button button_save = (Button) view.findViewById(R.id.button_save);

                final AlertDialog dialog_peripheral_input = builder.create();
                dialog_peripheral_input.show();

                button_save.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String deviceAddress = add_device.getText().toString();
                        String deviceName = name_device.getText().toString();
                        ...
                        startActivity(intent);
                        dialog_peripheral_input.dismiss();
                    }
                });
            }
        });
